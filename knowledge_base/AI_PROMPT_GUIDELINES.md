...
3. **Date Accuracy:** When extracting dates, the AI must verify the context. If the text says "last year in October," the AI should not list it as an upcoming "Important Date."
4. **Summary Structure:**
   - Paragraph 1: What is the transit/event?
   - Paragraph 2: What is the spiritual impact?
   - Paragraph 3: What is the recommended remedy/action?